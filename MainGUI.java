/**
 * Created by julianvera on 12/15/16.
 */
import java.awt.*;
...
public class MainGUI extends JPanel implements ActionListener, MouseListener {
    private static final long serialVersionUID = 1L;

    public static int width = 500, height = width;
    ...
    public void window(int width, int height, MainGUI game){ //draw the frame and add exit functionality
